  ...
  return (
    <div>
      ...
      <div className="p-8 flex justify-evenly">
        <div>
          <Image width={300} height={300} src="/img/couple.png" alt="" />
        </div>
        <div>
          <Image width={300} height={300} src="/img/family.png" alt="" />
        </div>
        <div>
      ...
      <div className="p-8 flex justify-evenly">
        ...
        <div>
        <Image width={300} height={300} src="/img/big box.png" alt="" />
        </div>
      </div>
      <div className="p-8 flex justify-evenly">
        <div>
        ...
        <div>
        <Image width={300} height={300} src="/img/4box.png" alt="" />
        </div>
      </div>
    </div>
  );
