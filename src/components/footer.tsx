    ...
    <footer className=" bg-purple-900 body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="flex w-auto  sm:ml-auto">
          <div className="md:grid grid-cols-2 gap-4  hidden place-content-stretch">
            <div className="ml-3  text-white">Keluahan</div>
            <Link href={"/request"}>
              <button>
                <div className="ml-3 text-white">Saran</div>
              </button>
            </Link>
            <div className="ml-3 text-white">KerjaSama</div>
            <div className="ml-3 text-white">Privacy & Policy</div>
          </div>
        </span>
      </div>
      <div className="container gap-7 px-4 py-0 mx-auto flex items-center sm:flex-row flex-col">
        <div>
          <svg
            width="36"
            height="36"
      ...
      <div className="container pt-5 px-4 py-0 mx-auto flex items-center sm:flex-row flex-col">
